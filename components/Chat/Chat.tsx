...
const Chat = ({id,authorAvatar,content,image,author}:Message) => {
    return (
        ...
        <Image src={authorAvatar} alt="ss" width={50} height={50} className="w-[30px] rounded-full h-[30px] my-1" />
...
{image && <Image decoding="async" loading="lazy" className="w-full border border-neutral-700 my-5 shadow-sm  object-center max-w-full object-cover h-[300px]" width="200" height="300" src={image as any} alt="chat image"/>
}
     </div>
          </div>
