...
const Modal = ({title,handleClose,children}:any) => {
    ...
    return createPortal(
       ...
       ">
       <div ref={modalRef} className="w-[400px] min-h-[400px] bg-neutral-950 shadow-lg rounded-sm flex items-center justify-center flex-wrap flex-row  border border-neutral-800">
